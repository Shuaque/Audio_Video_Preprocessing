...
# Function to handle SCP files to create a dictionary of file names and their absolute paths
...
if __name__ == "__main__":
    ...
    # Test the SCP file creation and reading
    scp_file = '../data/train_mix.scp'
    scp_dict = handle_scp(scp_file)
    print(type(scp_dict))
